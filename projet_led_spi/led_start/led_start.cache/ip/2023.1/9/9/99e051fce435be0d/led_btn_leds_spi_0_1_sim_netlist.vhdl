...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_p2s is
  port (
    ...
    ready_reg_reg_1 : in STD_LOGIC_VECTOR ( 0 to 0 );
...
ce_reg_i_1: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_leds_spi is
  ...
  signal FSM_SPI_inst_n_38 : STD_LOGIC;
  signal FSM_SPI_inst_n_4 : STD_LOGIC;
  signal FSM_SPI_inst_n_40 : STD_LOGIC;
  ...
  signal FSM_SPI_inst_n_6 : STD_LOGIC;
...
FSM_SPI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_FSM_SPI
     port map (
      ...
      Q(3) => FSM_SPI_inst_n_2,
      Q(2) => \^spi_ready\,
      Q(1) => FSM_SPI_inst_n_4,
      Q(0) => FSM_SPI_inst_n_5,
      RESET => RESET,
      SR(0) => FSM_SPI_inst_n_43,
      START => START,
      \bit_counter_reg[0]\(0) => bit_counter(0),
      ce_reg => ce_reg,
      ce_reg_reg(0) => FSM_SPI_inst_n_40,
      clk_reg_reg => clk_reg_reg,
      clk_spi => \^clk_spi\,
...
p2s_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_p2s
     port map (
      ...
      ready_reg_reg_1(0) => FSM_SPI_inst_n_5,
