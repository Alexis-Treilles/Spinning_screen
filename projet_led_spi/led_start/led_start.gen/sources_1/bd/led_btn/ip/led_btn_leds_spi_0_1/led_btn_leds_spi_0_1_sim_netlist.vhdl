...
--               d:/Vivado/projet_led_spi/led_start/led_start.gen/sources_1/bd/led_btn/ip/led_btn_leds_spi_0_1/led_btn_leds_spi_0_1_sim_netlist.vhdl
...
entity led_btn_leds_spi_0_1_FSM_SPI is
  port (
  ...
  attribute ORIG_REF_NAME of led_btn_leds_spi_0_1_FSM_SPI : entity is "FSM_SPI";
end led_btn_leds_spi_0_1_FSM_SPI;

architecture STRUCTURE of led_btn_leds_spi_0_1_FSM_SPI is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity led_btn_leds_spi_0_1_compteur_adr is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of led_btn_leds_spi_0_1_compteur_adr : entity is "compteur_adr";
end led_btn_leds_spi_0_1_compteur_adr;

architecture STRUCTURE of led_btn_leds_spi_0_1_compteur_adr is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity led_btn_leds_spi_0_1_p2s is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of led_btn_leds_spi_0_1_p2s : entity is "p2s";
end led_btn_leds_spi_0_1_p2s;

architecture STRUCTURE of led_btn_leds_spi_0_1_p2s is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity led_btn_leds_spi_0_1_leds_spi is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of led_btn_leds_spi_0_1_leds_spi : entity is "leds_spi";
end led_btn_leds_spi_0_1_leds_spi;

architecture STRUCTURE of led_btn_leds_spi_0_1_leds_spi is
...
begin
  SPI_ready <= \^spi_ready\;
  clk_spi <= \^clk_spi\;
FSM_SPI_inst: entity work.led_btn_leds_spi_0_1_FSM_SPI
     port map (
      CLOCK => CLOCK,
...
compteur_adr_inst: entity work.led_btn_leds_spi_0_1_compteur_adr
     port map (
      CLOCK => CLOCK,
      E(0) => s_enable_count,
...
p2s_inst: entity work.led_btn_leds_spi_0_1_p2s
     port map (
      CLOCK => CLOCK,
      D(31 downto 1) => p_2_in(31 downto 1),
      D(0) => FSM_SPI_inst_n_39,
...
entity led_btn_leds_spi_0_1 is
  ...
  attribute NotValidForBitStream of led_btn_leds_spi_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of led_btn_leds_spi_0_1 : entity is "led_btn_leds_spi_0_1,leds_spi,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of led_btn_leds_spi_0_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of led_btn_leds_spi_0_1 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of led_btn_leds_spi_0_1 : entity is "leds_spi,Vivado 2023.1";
end led_btn_leds_spi_0_1;

architecture STRUCTURE of led_btn_leds_spi_0_1 is
...
begin
U0: entity work.led_btn_leds_spi_0_1_leds_spi
     port map (
      CLOCK => CLOCK,
      RESET => RESET,
      SPI_ready => SPI_ready,
