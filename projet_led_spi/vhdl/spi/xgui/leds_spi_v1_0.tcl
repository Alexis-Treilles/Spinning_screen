...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "freq_div" -parent ${Page_0}
...
proc update_PARAM_VALUE.freq_div { PARAM_VALUE.freq_div } {
	# Procedure called to update freq_div when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.freq_div { PARAM_VALUE.freq_div } {
	# Procedure called to validate freq_div
	return true
}


proc update_MODELPARAM_VALUE.freq_div { MODELPARAM_VALUE.freq_div PARAM_VALUE.freq_div } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.freq_div}] ${MODELPARAM_VALUE.freq_div}
}
